...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="purse1a.JPG" width="100%" id="ProductImg">
				<div class="small-img-row">
					<div class="small-img-col">
					<img src="purse1b.JPG" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="purse1c.JPG" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="purse1d.JPG" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="purse1e.JPG" width="100%" class="small-img">
					</div>
