...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="8a.jpg" width="100%" id="ProductImg">
				<div class="small-img-row">
					<div class="small-img-col">
					<img src="8a.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="8b.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="8c.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="8d.jpg" width="100%" class="small-img">
					</div>
		...
		<div class="col-2">
			<p></p>
			<h1>The Rust </h1>
			<h3>Shirt</h3><br><p>Bunt Orange Raw Silk Shirt with Hand Embrioded work Sleves with gota embroidary and Maroon Inner in Silk </p><br>
			...
			<h3>LOWER</h3><br><p>Jamawar Pent</p><br>
			<br>
