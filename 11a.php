...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="purse2a.JPG" width="100%" id="ProductImg">
				<div class="small-img-row">
					<div class="small-img-col">
					<img src="purse2b.JPG" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="purse2c.JPG" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="purse2a.JPG" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="purse2e.JPG" width="100%" class="small-img">
					</div>
