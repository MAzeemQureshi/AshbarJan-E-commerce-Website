...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="6a.jpg" width="100%" id="ProductImg">
				<div class="small-img-row">
					<div class="small-img-col">
					<img src="6a.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="6b.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="6c.jpg" width="100%" class="small-img">
					</div>
