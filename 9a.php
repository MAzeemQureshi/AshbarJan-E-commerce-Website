...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="9a.jpg" width="100%" id="ProductImg">
				<div class="small-img-row">
					<div class="small-img-col">
					<img src="9a.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="9b.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="9c.jpg" width="100%" class="small-img">
					</div>
