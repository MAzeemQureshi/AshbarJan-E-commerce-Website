...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="2a.jpg" width="100%" id="ProductImg">
				<div class="small-img-row">
					<div class="small-img-col">
					<img src="2a.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="2b.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="2c.jpg" width="100%" class="small-img">
					</div>
		...
		<div class="col-2">
			<p></p>
			<h1>Kina Green Bridal</h1>			
			<h3>Shirt</h3><br><p>Parrot green net shirt with floral pattern work on the front and back.</p><br>
			<h3>WORK</h3><br><p>Nakshi/Dabka, Gota, Embroidery, Stone and Colored ssequin work</p><br>
			<h3>LOWER</h3><br><p>Lower Shaded velvet garara with worked border</p>
			<br>
			<h3>Dupatta</h3><br><p>Magenta net dupatta with embroidered floral motifs all over. chatha of sequins stones pearl and gota with scalloped edges.</p>
			<br>
