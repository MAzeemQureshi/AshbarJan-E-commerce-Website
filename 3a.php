...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="3a.jpg" width="100%" id="ProductImg">
				<div class="small-img-row">
					<div class="small-img-col">
					<img src="3a.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="3b.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="3c.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="3d.jpg" width="100%" class="small-img">
					</div>
		...
		<div class="col-2">
			<p></p>
			<h1>Lotus Pink Shirt</h1>
			<h3>Shirt</h3><br><p>Lotus Pink shirt in Tissue with floral pattern work on the front and back. Nets are added on sleeves</p><br>
			<h3>WORK</h3><br><p>Nakshi/Dabka, Embroidery, Stone and Colored ssequin work</p><br>
			<h3>LOWER</h3><br><p>Lower Jamawwar Pent with worked border</p>
			<br>
