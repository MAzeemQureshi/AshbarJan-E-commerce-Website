...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="5a.jpg" width="100%" id="ProductImg">
				<div class="small-img-row">
					<div class="small-img-col">
					<img src="5a.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="5b.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="5c.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="5d.jpg" width="100%" class="small-img">
					</div>
		...
		<div class="col-2">
			<p></p>
			<h1>Rose Pink Andrakha</h1>
			<h3>Shirt</h3><br><p>Rose Pink in Tissue with the plain slip and heavily worked belt</p><br>
			...
			<h3>LOWER</h3><br><p>Katan Silk Plain  Cigarette Pent</p><br>
			<h3>Dupatta</h3><br><p>Shaded Organza dupatta</p><br>
			<br>
