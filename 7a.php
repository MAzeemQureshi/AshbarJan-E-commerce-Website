...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="7a.jpg" width="100%" id="ProductImg">
				<div class="small-img-row">
					<div class="small-img-col">
					<img src="7a.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="7b.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="7c.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="7d.jpg" width="100%" class="small-img">
					</div>
				
					<div class="small-img-col">
					<img src="7e.jpg" width="100%" class="small-img">
					</div>
				</div>
			</div>
		<div class="col-2">
			<p></p>
			<h1>The Ivery</h1>
			<h3>Shirt</h3><br><p>Emerald Green Net Shirt with Hand Embrioded work Sleves with gota embroidary</p><br>
			<h3>WORK</h3><br><p>Resham, colored and gold Sequins, 3D Detailing, Dabka, Nakshi Gota Embroidery. Worked Neckline at the back</p><br>
			<h3>LOWER</h3><br><p>Velvet with Border</p><br>
			<h3>Dupatta</h3><br><p>MultiShaded Organza dupatta</p><br>
			<br>
