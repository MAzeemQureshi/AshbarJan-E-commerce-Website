...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="1b.jpg" width="100%" id="ProductImg">
				<div class="small-img-row">
					<div class="small-img-col">
					<img src="1a.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="1b.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="1c.jpg" width="100%" class="small-img">
					</div>
					
					<div class="small-img-col">
					<img src="1d.jpg" width="100%" class="small-img">
					</div>
		...
		<div class="col-2">
			<p></p>
			<h1>Enchanted Black</h1>
			<h3>Shirt</h3><br><p>High quality net shirt heavily embellished with Swarovski crystals, pearls, nakshi. </p>
			<h3>WORK</h3><br><p>It is enhanced with beautifully worked flowers encrusted with crystal and Pearl stamens with hand crafted color embroidary. With Plain Slip.</p>
			<h3>LOWER</h3><br><p>Lower in indian raw silk</p>
			<br>
			...
			<a href="https://wa.me/+923238819474>" target="_blank"><h3>Chat with our Team</h3> <button type="" class="btn"><i class="fa fa-whatsapp" aria-hidden="true"></i> Whatsapp Us</button></a>
		</div>
	</div>
</div>
